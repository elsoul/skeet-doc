          ...
          <div className="pl-6 pr-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pl-24 lg:pr-0 xl:pl-32">
            ...
            <div className="mt-8">
              <a
                href={
                  isJapanese
                    ? siteConfig.feedbackFormJA
                    : siteConfig.feedbackFormEN
                }
                rel="noreferrer"
                target="_blank"
                className="inline-flex bg-white/10 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-white/20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
              >
